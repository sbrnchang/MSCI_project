...
{
  // double snow_blob1 = 0.1 * exp(-(pow(nx + 0.1, 2) + pow(ny + 0.3, 2)) / 0.1);
  double snow_blob2 = 0.4 * exp(-(pow(nx + 0.3, 2) + pow(ny + 0.3, 2)) / 0.3);
  return snow_blob2 ;
}
...
double synthetic_gaussian_ice(double nx, double ny)
{
  ...
  double ice_center = 4 * exp(-(pow(nx + 0.45, 2) + pow(ny + 0.2, 2)) / 0.2);
